      ...
      <div className='flex items-center gap-6'>
        ...
        <div className='group relative'>
          {user ? (
            ...
            <Link to='/login'><img className='w-5 cursor-pointer' src={assets.profile_icon} alt="login" /></Link>
          )}
            ...
            <div className='flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded shadow'>
              {user ? (
                <>
                  ...
                  <p onClick={logout} className='cursor-pointer hover:text-black text-red-500'>Logout</p>
                </>
              ) : (
